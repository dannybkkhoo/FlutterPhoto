...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    _imageList.add("assets/Capture01.PNG");
    _imageList.add("assets/Capture02.PNG");
    _imageList.add("assets/Capture03.PNG");
    _imageList.add("assets/Capture04.PNG");
    _imageList.add("assets/Capture05.PNG");
    _imageList.add("assets/Capture06.PNG");
    _imageList.add("assets/Capture07.PNG");
    _imageList.add("assets/Capture08.PNG");
    _imageList.add("assets/Capture09.PNG");
  }
