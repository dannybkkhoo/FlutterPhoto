                  ...
                  child: Column(
                    ...
                    children: [
                      AlertDialog(
                        ...
                        content: content !=null ? Center(child: Text(content, style: Theme.of(context).textTheme.headline5),):null,
                        contentPadding: EdgeInsets.fromLTRB(13.0, 13.0, 13.0, 0.0),
                        elevation: 10.0,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.all(Radius.circular(13.0)),
                        ),
                        title: title !=null ? Text(title, style: Theme.of(context).textTheme.subtitle1):null,
